  ...
  <div>
    <BlockHero
      :link="{
        link: '#',
        title: 'AI Coach',
        icon: 'line-md:volume-low-filled',
      }"
      title="AI Coach"
    />
      ...
      >
        <template v-if="aiCoachStore.messages.length === 0">
          <div class="text-center text-gray-400 mt-8">
            ...
            <p>
              Start chatting with your AI Coach! I can help you with your
        ...
        <template v-else>
          <div
            v-for="message in aiCoachStore.messages"
...
Keep responses concise, friendly, and focused on helping the user achieve their fitness goals. Provide specific, actionable advice based on their workout history and available routines.`,
  ...
  if (aiCoachStore.messages.length === 0) {
    aiCoachStore.addMessage(
      "assistant",
      "Hello! I'm your AI fitness coach. I can help you with your workouts and routines. What would you like to know?",
    );
  }
